...
Por favor @${m.mentionedJid[0].split`@`[0]} para digitar aceitar/rejeitar`
	    ...
	    case 'pix': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'social': {
                m.reply('*Segue nos nas redes Sociais:*
				
				Twitch.Tv: https://www.twitch.tv/ladyaire   
				Twitch.Tv: https://www.twitch.tv/fortnite_semcor     
				Tik-Tok: https://www.tiktok.com/@fortnite_semcor      
				You-Tube https://www.youtube.com/c/FortniteSemCor    
				Discord: https://discord.gg/MAjjb3U4Jz    
				
				Seguer nois nais rede social para ajuda\n\n Obrigado(a)\n\nPIX: +557996384290')
            }
            break
            case 'chat': {
