...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'family100': {
                ...
                let hasil = `*Responda as seguintes questões:*\n${random.soal}\n\nSer encontrado *${random.jawaban.length}* Responda ${random.jawaban.find(v => v.includes(' ')) ? `(beberapa Jawaban Terdapat Spasi)` : ''}`.trim()
            ...
            case 'tebak': {
                ...
                if (args[0] === "lagu") {
                    ...
                    hisoka.sendButtonText(m.chat, [{ buttonId: 'Adivinhe a musica', buttonText: { displayText: 'Adivinhe a musica' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nQuero jogar? aperte o botão abaixo`, hisoka.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    }
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            let ments = [me, jodoh]
            let buttons = [
                        { buttonId: 'Proximo casal', buttonText: { displayText: 'Proximo casal' }, type: 1 }
                    ]
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `Casal do Grupo! 💖 felicidades ao Casal🐤
