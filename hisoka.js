/**
* Base: https://discord.gg/MAjjb3U4Jz
*/
...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
    try {
        ...
        const isCreator = [botNumber, ...global.dono].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
        ...
        const groupDono = m.isGroup ? groupMetadata.dono : ''
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  // Anti Link
        ...
        m.reply(`「 ANTI LINK 」\n\nFoi detectado envio de link no grupo, desculpe, você será expulso, dúvida fale com um adm do grupo!`)
        if (!isBotAdmins) return m.reply(`Ehh bot gak admin T_T`)
        let gclink = (`https://chat.whatsapp.com/`+await hisoka.groupInviteCode(m.chat))
        let isLinkThisGc = new RegExp(gclink, 'i')
        let isgclink = isLinkThisGc.test(m.text)
        if (isgclink) return m.reply(`Você sabia que nao podia enviar link aqui no grupo`)
        if (isAdmins) return m.reply(`Eh desculpa você administrador`)
        if (isCreator) return m.reply(`Ehh desculpe você e meu dono`)
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
            ...
            m.reply('Esperando o parceiro' + (text ? ` mengetik command dibawah ini ${prefix}${command} ${text}` : ''))
            ...
            if (this.game) {
            delete this.game
            hisoka.sendText(m.chat, `Excluir com sucesso a sessão TicTacToe`, m)
            } else if (!this.game) {
	    ...
	    if (m.mentionedJid[0] === m.sender) return m.reply(`Não pode jogar com você mesmo!`)
            if (!m.mentionedJid[0]) return m.reply(`_Quem você quer desafiar?_\nMarque a pessoa na frente do comando..\n\nContoh : ${prefix}suit @${dono[1]}`, m.chat, { mentions: [dono[1] + '@s.whatsapp.net'] })
...
Por favor @${m.mentionedJid[0].split`@`[0]} para digitar aceitar/rejeitar`
            ...
            break
	    case 'pix': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/d9b53b84e24f50b8921b9.jpg' }, caption: `*Oi: ${m.pushName}*\n\n *Preços do aluguel do bot*\n⭔ 7 dias, 5 Reais\n⭔ 15 dias, 10 Reais\n⭔ 30 dias, 16 Reais\n\nO pagamento e via PIX - Faler com meu dono no pv.\n\nPara mais detalhes, você pode conversar com meu dono\nhttps://wa.me/5522992224505 (Dono)\n\nAjuder o bot ficar online faça uma *Doação pelo PIX* de qualquer valor para o bot ficar ativo:\n\n⭔ PIX: +557996384290` }, { quoted: m })
            }
            break
            case 'social': {
                m.reply('*Segue nos nas redes Sociais:*  :	Twitch.Tv: https://www.twitch.tv/ladyaire  :	Twitch.Tv: https://www.twitch.tv/fortnite_semcor  :	Tik-Tok: https://www.tiktok.com/@fortnite_semcor  :	You-Tube https://www.youtube.com/c/FortniteSemCor  :	Discord:https://discord.gg/MAjjb3U4Jz      :	Seguer nois nais rede social para ajuda\n\n Obrigado(a)\n\nPIX: +557996384290')
            }
            break
            case 'chat': {
            ...
            break
            case 'repetir': case 'hilih': case 'huluh': case 'heleh': case 'holoh':
            if (!m.quoted && !text) throw `Coloque a mensagem na frente do comando ${prefix + command}`
            ...
            case 'jogos': {
                ...
                if (args[0] === "lagu") {
                    ...
                    hisoka.sendText(m.chat, `Esta musica e de quem?\n\nArtista : ${result.artist}\nTempo : 60s`, msg).then(() => {
                    ...
                    if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) throw "Ainda há sessões inacabadas!"
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    hisoka.sendButtonText(m.chat, [{ buttonId: 'Adivinhe a palavra', buttonText: { displayText: 'Adivinhe a palavra' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nQuero jogar? aperte o botão abaixo`, hisoka.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    hisoka.sendButtonText(m.chat, [{ buttonId: 'Adivinhe a frase', buttonText: { displayText: 'Adivinhe a frase' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nQuero jogar? aperte o botão abaixo`, hisoka.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    }
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    hisoka.sendButtonText(m.chat, [{ buttonId: 'Adivinhe a letra', buttonText: { displayText: 'Adivinhe a letra' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nQuero jogar? aperte o botão abaixo`, hisoka.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    }
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    hisoka.sendButtonText(m.chat, [{ buttonId: 'Acho que e bolo de arroz', buttonText: { displayText: 'Adivinha Lontong' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, hisoka.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
                    }
                }
            ...
            let jawab = `👫Seguer o casal Gay do Grupo! ❤️

@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            let ments = [me, jodoh]
            let buttons = [
                        { buttonId: 'casalgay', buttonText: { displayText: 'Proximo casal' }, type: 1 }
                    ]
            ...
            let jodoh = member[Math.floor(Math.random() * member.length)]
            let jawab = `Olha o casal do Grupo! 💖 felicidades ao Casal🐤
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            case 'join': {
                if (!isCreator) throw mess.dono
                if (!text) throw 'Insira um grupo de links!'
	...
	break
	    case 'setname': case 'setsubject': {
            ...
            break
          case 'descgp': case 'setdesk': {
                if (!m.isGroup) throw mess.group
                if (!isBotAdmins) throw mess.botAdmin
                if (!isAdmins) throw mess.admin
                if (!text) throw 'Coloque o texto na frente do comando, altere a descrição do grupo!'
                await hisoka.groupUpdateDescription(m.chat, text).then((res) => m.reply(mess.success)).catch((err) => m.reply(jsonformat(err)))
            }
            break
          case 'fotogrupo': {
                if (!isCreator) throw mess.dono
                if (!quoted) throw `Marque uma imagem para troca a foto do grupo ${prefix + command}`
                if (!/image/.test(mime)) throw `Marque uma imagem para troca a foto do grupo ${prefix + command}`
                if (/webp/.test(mime)) throw `Marque uma imagem para troca a foto do grupo ${prefix + command}`
                let media = await hisoka.downloadAndSaveMediaMessage(quoted)
                await hisoka.updateProfilePicture(botNumber, { url: media }).catch((err) => fs.unlinkSync(media))
                m.reply(mess.success)
                }
                break
           case 'nomegp': case 'setppgrup': case 'setppgc': {
                if (!m.isGroup) throw mess.group
                if (!isAdmins) throw mess.admin
                if (!quoted) throw `Coloque a mgs na frente do comando para troca o nome do grupo ${prefix + command}`
                if (!/image/.test(mime)) throw `Coloque a mgs na frente do comando para troca o nome do grupo ${prefix + command}`
                if (/webp/.test(mime)) throw `Coloque a mgs na frente do comando para troca o nome do grupo ${prefix + command}`
                let media = await hisoka.downloadAndSaveMediaMessage(quoted)
...
let teks = `══✪〘 *👥 Tag All* 〙✪══
 ...
 ➲ *Mensagem: ${q ? q : 'texto'}*\n\n`
		...
		if (!text) throw 'Digite o texto da consulta na frente do comando!'
	    ...
	    break
            ...
            if (!text) throw `Insira o motivo do voto, exemplo: *${prefix + command} Dono e Bonito*`
            m.reply(`A votação começou!\n\n*${prefix}upvote* - Sim\n*${prefix}devote* - Não\n*${prefix}cekvote* - Verificar o voto\n*${prefix}hapusvote* - Deletar a votação`)
            vote[m.chat] = [q, [], []]
            await sleep(1000)
...
*${prefix}hapusvote* - Deletar a votação`
let buttonsVote = [
  {buttonId: `${prefix}upvote`, buttonText: {displayText: 'SIM'}, type: 1},
  {buttonId: `${prefix}devote`, buttonText: {displayText: 'NÃO'}, type: 1}
]
...
*${prefix}hapusvote* - para a votação`
            let buttonsUpvote = [
            ...
            hisoka.sendMessage(m.chat, buttonMessageUpvote)
             ...
             break
                case 'devote': {
            if (!m.isGroup) throw mess.group
            if (!(m.chat in vote)) throw `_*Não ha votação neste grupo!*_\n\n*${prefix}vote* - Para começar a votar`
            isVote = vote[m.chat][1].concat(vote[m.chat][2])
            wasVote = isVote.includes(m.sender)
            if (wasVote) throw 'Você votou'
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            if (!(m.chat in vote)) throw `_*sem votação neste grupo!*_\n\n*${prefix}vote* - para começar a votar`
            delete vote[m.chat]
            m.reply('Excluido a seção de votação neste grupo com sucesso')
	    }
            break
               case 'grupo': case 'grup': {
                ...
                let buttons = [
                        { buttonId: 'Grupo aberto', buttonText: { displayText: 'Abrir' }, type: 1 },
                        { buttonId: 'Grupo fechado', buttonText: { displayText: 'Fechar ' }, type: 1 }
                    ]
                    await hisoka.sendButtonText(m.chat, buttons, `Selecione o modo de grupo`, hisoka.user.name, m)
            ...
            case 'editdesc': {
                ...
                if (!isAdmins) throw mess.admin
             if (args[0] === 'Abrir'){
                await hisoka.groupSettingUpdate(m.chat, 'Abrir').then((res) => m.reply(`A descrição do grupo foi aberta com sucesso`)).catch((err) => m.reply(jsonformat(err)))
             } else if (args[0] === 'Fechar'){
                await hisoka.groupSettingUpdate(m.chat, 'Fechar').then((res) => m.reply(`A descrição do grupo foi fechado com sucesso`)).catch((err) => m.reply(jsonformat(err)))
             } else {
             let buttons = [
                        { buttonId: 'Descrição do grupo esta pública', buttonText: { displayText: 'Abrir' }, type: 1 },
                        { buttonId: 'Descrição do grupo so para adms', buttonText: { displayText: 'Fechar' }, type: 1 }
                    ]
                    await hisoka.sendButtonText(m.chat, buttons, `Informações de edição da descrição`, hisoka.user.name, m)
            ...
            case 'antilink': {
                ...
                if (!isAdmins) throw mess.admin
                if (args[0] === "on") {
                if (db.data.chats[m.chat].antilink) return m.reply(`Foi ativado`)
                db.data.chats[m.chat].antilink = true
                m.reply(`Antilink ativo!`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].antilink) return m.reply(`Foi desativado`)
             ...
             case 'mutebot': {
                ...
                if (!isAdmins) throw mess.admin
                if (args[0] === "on") {
                if (db.data.chats[m.chat].mute) return m.reply(`Ativo`)
                db.data.chats[m.chat].mute = true
                m.reply(`${hisoka.user.name} Foi silenciado neste grupo!`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`Desativado`)
                db.data.chats[m.chat].mute = false
                m.reply(`${hisoka.user.name} Foi ativado`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'On' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'Off' }, type: 1 }
                    ]
                    await hisoka.sendButtonText(m.chat, buttons, `Silenciar o comando do bot no Grupo!`, hisoka.user.name, m)
                }
             }
             break
            ...
            case 'msgtemporaria': {
                ...
                if (!isBotAdmins) throw mess.botAdmin
                if (!isAdmins) throw mess.admin
                if (!text) throw 'Messagem temporarias do grupo enable/disable'
                if (args[0] === 'enable') {
            ...
            case 'bcgc': case 'bcgrupo': {
                if (!isCreator) throw mess.dono
                if (!text) throw `Text mana?\n\nExemplo: ${prefix + command} Sua Msg!`
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'Conexão Gamer',
                                    url: 'https://discord.gg/MAjjb3U4Jz'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Número do Dono',
                                    phoneNumber: '+55 22-99222-4505'
                                }
                            }, {
                                quickReplyButton: {
                ...
                m.reply(`Enviando com sucesso a transmissão para ${anu.length} Group`)
            }
            break
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://encurtador.com.br/bsFS2'
                                }
                            }, {
                                callButton: {
		...
		m.reply('Sukses Broadcast')
            ...
            case 'infochat': {
                ...
                for (let i of msg.userReceipt) {
                    ...
                    teks += ` ┗━⭔ *Tempo:* ${moment(waktu * 1000).format('DD/MM/YY HH:mm:ss')} ⭔ *Status :* ${read ? 'Dibaca' : 'Terkirim'}\n\n`
                }
	    ...
	    break
            case 'listpc': {
             ...
             break
                case 'listgc': {
                 ...
                 for (let i of anu) {
                     ...
                     teks += `⬡ *Nome:* ${metadata.subject}\n⬡ *Dono:* @${metadata.dono.split('@')[0]}\n⬡ *ID:* ${metadata.id}\n⬡ *Criada:* ${moment(metadata.creation * 1000).tz('Asia/Jakarta').format('DD/MM/YYYY HH:mm:ss')}\n⬡ *Member :* ${metadata.participants.length}\n\n────────────────────────\n\n`
                 }
                 hisoka.sendTextWithMentions(m.chat, teks, m)
             }
             break
             case 'listonline': case 'liston': {
                    ...
                    hisoka.sendText(m.chat, 'Membros Online:\n\n' + online.map(v => '⭔ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
             break
            ...
            m.reply(mess.wait)
                ...
                throw `Coloque a mensagem na frente do comando ${prefix + command}\nDurasi Video 1-9 Detik`
                }
            }
            break
            case 'ebinary': {
            if (!m.quoted.text && !text) throw `Coloque a mensagem na frente do comando ${prefix + command}`
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            if (!/video/.test(mime) && !/audio/.test(mime)) throw `Converter audio e video para mp3, So marcar, Como áudio com legenda! ${prefix + command}`
            if (!quoted) throw `Converter audio e video para mp3, So marcar, Como áudio com legenda! ${prefix + command}`
            m.reply(mess.wait)
            let media = await quoted.download()
            ...
            break
            case 'tomp3': {
            if (/document/.test(mime)) throw `Converter audio e video para mp3, So marcar! ${prefix + command}`
            if (!/video/.test(mime) && !/audio/.test(mime)) throw `Converter audio e video para mp3, So marcar! ${prefix + command}`
            if (!quoted) throw `Converter audio e video para mp3, So marcar! ${prefix + command}`
            m.reply(mess.wait)
            let media = await quoted.download()
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            hisoka.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convertido por ${hisoka.user.name}.mp3`}, { quoted : m })
            }
            break
            ...
            case 'togif': {
                if (!quoted) throw 'Reply Image'
                if (!/webp/.test(mime)) throw `responder sticker com legenda *${prefix + command}*`
                m.reply(mess.wait)
		let { webp2mp4File } = require('./lib/uploader')
                let media = await hisoka.downloadAndSaveMediaMessage(quoted)
                let webpToMp4 = await webp2mp4File(media)
	    ...
	    if (!quoted) throw `Responder Imagem com Legenda ${prefix + command}`
	    if (!/image/.test(mime)) throw `Responder Imagem com Legenda ${prefix + command}`
	    if (/webp/.test(mime)) throw `Responder Imagem com Legenda ${prefix + command}`
	    ...
	    case 'yts': case 'ytsearch': {
            ...
            break
        case 'google': {
                if (!text) throw `Exemplo: ${prefix + command} funk brasil`
                ...
                break
        case 'imagem': {
        if (!text) throw `Exemplo: ${prefix + command} Celular s20`
...
⭔ Visualizações : ${search.videos[0].views}
⭔ Author : ${search.videos[0].author.name}
⭔ Duração : ${search.videos[0].timestamp}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
                }
	    ...
	    case 'ytmp3': case 'ytaudio': {
                ...
                if (!text) throw `Example : ${prefix + command} https://youtube.com/watch?v=K9nMa0lCoEE&t%27 128kbps`
                let quality = args[1] ? args[1] : '128kbps'
                let media = await yta(text, quality)
                if (media.filesize >= 100000) return m.reply('Arquivo acima do limite '+util.format(media))
                hisoka.sendImage(m.chat, media.thumb, `⭔ Título: ${media.title}\n⭔ Tamanho: ${media.filesizeF}\n⭔ Qualidade: ${args[1] || '128kbps'}`, m)
                hisoka.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted: m })
            }
            break
            case 'ytmp4': case 'ytvideo': {
                let { ytv } = require('./lib/y2mate')
                if (!text) throw `Example : ${prefix + command} https://youtube.com/watch?v=K9nMa0lCoEE&t%27 360p`
                let quality = args[1] ? args[1] : '360p'
                let media = await ytv(text, quality)
                if (media.filesize >= 100000) return m.reply('Arquivo acima do limite '+util.format(media))
                hisoka.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `⭔ Título : ${media.title}\n⭔ Tamanho: ${media.filesizeF}\n⭔ Qualidade : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
	    case 'getmusic': {
                let { yta } = require('./lib/y2mate')
		...
		let urls = quoted.text.match(new RegExp(/(?:https?:\/\/)?(?:youtu\.be\/|(?:www\.|m\.)?youtube\.com\/(?:watch|v|embed|shorts)(?:\.php)?(?:\?.*v=|\/))([a-zA-Z0-9\_-]+)/, 'gi'))
                if (!urls) throw `Talvez a mensagem que você respondeu não contenha o resultado de busca`
                let quality = args[1] ? args[1] : '128kbps'
	    ...
	    case 'metadinha': {
                ...
                hisoka.sendMessage(m.chat, { image: { url: random.male }, caption: `Casal Masculino` }, { quoted: m })
                hisoka.sendMessage(m.chat, { image: { url: random.female }, caption: `Casal Feminino` }, { quoted: m })
            }
	    break
            case 'cafe': case 'kopi': {
            let buttons = [
                    {buttonId: `cafe`, buttonText: {displayText: 'Próxima imagem'}, type: 1}
                ]
                let buttonMessage = {
            ...
            break
            case 'wallpaper': {
                if (!text) throw 'Insira um título para a consulta'
	    ...
	    case 'suavida': case 'nomorhoki': {
            ...
            case 'suamiistri': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `⭔ *Seu nome:* ${anu.message.suami.nama}\n⭔ *Seu nascimento:* ${anu.message.suami.tgl_lahir}\n⭔ *Nama Istri :* ${anu.message.istri.nama}\n⭔ *Lahir Istri :* ${anu.message.istri.tgl_lahir}\n⭔ *Hasil :* ${anu.message.result}\n⭔ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalancinta': case 'ramalcinta': {
                if (!text) throw `Example : ${prefix + command} Dika, 7, 7, 2005, Amiga, 16, 11, 2004`
                let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
            ...
            if (!text) throw 'Cadê o link? do video do tik-tok!'
            m.reply(mess.wait)
            fetchJson(`https://api.akuari.my.id/downloader/tiktok?link=${text}`).then(async linked => {
            hisoka.sendMessage(m.chat, {video: {url: `${linked.result.nowm}`}, mimetype: 'video/mp4', caption: 'Pronto ✅'}, {quoted: m})
            })
            }
            break
            ...
            m.reply(mess.wait)
            fetchJson(`https://api.akuari.my.id/downloader/tiktok?link=${text}`).then(async linked => {
            hisoka.sendMessage(m.chat, {video: {url: `${linked.result.video_original}`}, mimetype: 'video/mp4', caption: 'Pronto ✅'}, {quoted: m})
            })
            }
            break
            ...
            m.reply(mess.wait)
            fetchJson(`https://api.akuari.my.id/downloader/tiktok?link=${text}`).then(async linked => {
            hisoka.sendMessage(m.chat, {audio: {url: `${linked.result.audio}`}, mimetype: 'audio/mpeg', caption: 'Pronto ✅'}, {quoted: m})
            })
	    }
            break
	        case 'instagram': case 'ig': case 'igdl': {
                if (!text) throw 'Cadê o link? do video do instagram!'
                m.reply(mess.wait)
		...
		case 'igeh': case 'instagram2': case 'ig2': case 'igdl2': {
            ...
            case 'joox': case 'jooxdl': {
                if (!text) throw 'Cadê o link? do joox'
                m.reply(mess.wait)
            ...
            case 'twittermp3': case 'twitteraudio': {
                if (!text) throw 'Cadê o link? do video do da twitter!'
                m.reply(mess.wait)
                let anu = await fetchJson(api('zenz', '/api/downloader/twitter', { url: text }, 'apikey'))
                let buttons = [
	        ...
	        case 'fbdl': case 'fb': case 'facebook': {
                if (!text) throw 'Cadê o link? do video do facebook!'
                m.reply(mess.wait)
	        ...
	        case 'pindl': case 'pinterestdl': {
                if (!text) throw 'Cadê o link? do pinterest!'
                m.reply(mess.wait)
		...
		break
		   case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
            ...
            case 'delcmd': {
                ...
                if (global.db.data.sticker[hash] && global.db.data.sticker[hash].locked) throw 'Você não tem permissão para excluir este comando de sticker'              
...
Lihat list Pesan Dengan ${prefix}listmsg`)
	    ...
	    break
	    case 'anonimo': {
                if (m.isGroup) return m.reply('Recursos não podem ser usado no grupos, vai no meu pv!')
				this.anonymous = this.anonymous ? this.anonymous : {}
				let buttons = [
                    { buttonId: 'start', buttonText: { displayText: 'Start' }, type: 1 }
                ]
                hisoka.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await hisoka.getName(m.sender)} Bem-vindo ao chat anônimo\n\nClique no botão abaixo para encontrar um parceiro\`\`\``, hisoka.user.name, m)
            }
			break
	    ...
	    case 'call':{
	     if(text.includes("@")) {
                    exec("python3 call.py "+text.split("@55")[1], (err, stdout) => {
                        if(err) return m.reply(err)
                        if (stdout) return m.reply(stdout)
                    })
                    	...
                    	m.reply(`Digite o número\n${prefix+command} 22+++++++++\nou\nMarcar pelo\n${prefix+command} Marca o número`)
   l                 	}
             }
	    break
	    case 'spamsms':{
	     if(text.includes("@")) {
                    exec("python3 mpl.py "+text.split("@55")[1], (err, stdout) => {
                        if(err) return m.reply(err)
                        if (stdout) return m.reply(stdout)
                    })
                    } else if(text.startsWith("8")) {
	    ...
	    case 'phonenumber-info':{
	     if(text.includes("@")) {
                    exec("python3 dark-phoneinfo.py "+text.split("@")[1], (err, stdout) => {
                    	...
                    	m.reply(`Digite o número\n${prefix+command} +5522992288821\nou\nMarcar pelo\n${prefix+command} @Sabrina`)
                    	}
             }
	    break
	    case 'spam-wa':{
	     if(text.includes("@")) {
                    exec("python3 dark-wangsaff.py "+text.split("@55")[1], (err, stdout) => {
                        if(err) return m.reply(err)
                        if (stdout) return m.reply(stdout)
                    })
	    ...
	    break
            ...
            case 'ttp':{
                 if (!text) throw `Example: *${prefix + command} Perdi Gay*`
                 m.reply(mess.wait)
                 hisoka.sendMessage(m.chat, {image: {url: "https://api.akuari.my.id/other/ttp?text="+text}, caption: 'marque esta imagem e digitar !s para fazer sticker!'}, {quoted: m})
            }
            break
            ...
            case 'CaptchaGenerator':{
                 ...
                 hisoka.sendMessage(m.chat, {image: {url: "CAPTCHA.png"}, caption: 'Sucesso de Texto do Gerador de Captcha'})
            }
            break
            case 'webinfo':{
            ...
            case 'SsWeb': case 'ssweb': case 'Ssweb': case 'ScreenshotWeb': case 'screenshotweb':{
                 if (!text) throw `Example: *${prefix + command} https://www.google.com*`
                 m.reply(mess.wait)
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            case 'dono': case 'creator': {
                hisoka.sendContact(m.chat, global.dono, m)
            }
            break
...
•≽  ${prefix}wallpaper [txt]
•≽  ${prefix}wikimedia [txt] 
•≽  ${prefix}ytsearch [txt]
•≽  ${prefix}ringtone [txt]
•≽  ${prefix}cafe
•≽  ${prefix}nick [txt]
...
*« Menu do Grupo »*
•≽  ${prefix}linkgroup
•≽  ${prefix}msgtemporaria
•≽  ${prefix}fotogrupo [marcar]
•≽  ${prefix}nomegp [txt]
•≽  ${prefix}descgp [txt]
•≽  ${prefix}grupo [opção]
•≽  ${prefix}editdesc [option]
•≽  ${prefix}add [+55DDD+N]
•≽  ${prefix}ban @user
•≽  ${prefix}all
•≽  ${prefix}tagall [txt]
•≽  ${prefix}antilink
•≽  ${prefix}mutebot [grupo]
•≽  ${prefix}promove @user
•≽  ${prefix}rebaixa @user
•≽  ${prefix}vote [text]
•≽  ${prefix}ytaudio [url]
...
`
                let btn = [{
                        ...
                        hisoka.send5ButImg(m.chat, anu, 'Multi Device', global.thumb, btn)
                     }
            break
            default:
                if (budy.startsWith('=>')) {
